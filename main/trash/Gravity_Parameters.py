...
class Gravity_obj:
      ...
      def __init__(self):
         ...
         #Geometry Properties
         self.Metric_type_name        = read_data_string(tag_name = 'Metric_type',file_name = 'parameters/parameters.xml')
         self.Cosmological_cosntant   = read_data_float(tag_name = 'Cosmological_cosntant',file_name = 'parameters/parameters.xml')
